...
- [ ] 📸 آیا عکس های نویسنده وجود دارد؟
  - از جستجوی عکس معکوس استفاده کنید تا ببینید آیا همان تصاویر در جای دیگری ظاهر می شوند یا خیر در واقع عکس را در قسمت سرچ با عکس موتورهای جستجو سرچ میکنید.
